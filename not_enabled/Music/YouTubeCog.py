...
class YTDLSource(discord.PCMVolumeTransformer):
    ...
    @classmethod
    async def create_source(self, interaction: discord.Interaction, search: str, *, loop: asyncio.BaseEventLoop = None):
        print(interaction.user, interaction.channel)
        loop = loop or asyncio.get_event_loop()
        print("in create_source")
        ...
        return self(interaction, discord.FFmpegPCMAudio(info['url'], **self.FFMPEG_OPTIONS), data=info)
...
class YouTubeCog(commands.Cog):
    ...
    @app_commands.command(name="play", description=f"{os.getenv('APP_CMD_PREFIX')}Play a video or song from YouTube or Spotify")
    ...
    async def play_song(self, interaction: discord.Interaction, *, search: str):
        ...
        if search is None:
            await interaction.response.send_message("You must supply a search criteria.", ephemeral=True)
        ...
        async with interaction.channel.typing():
            ...
            try:
                ...
                await interaction.response.send_message(f'An error occurred while processing this request', ephemeral=True)
            else:
                song = Song(source)
...
# async def setup(client: commands.Bot):
    # await client.add_cog(YouTubeCog(client))